        ...
        <div class = "container my-5 py-3">
            <div class = "row">
                ...
                <div class = "col-3 pt-5 side-bar-menu">
                    <nav>
                        <ul>
                            ...
                            <a href = "engineering_and_science.php"><li class = "activeLink">Engineering &amp; Science</li></a>
                ...
                <div class = "col-md-8 mx-md-auto col-12 justify-content text-justify">
                    <!-- Section heading -->
                    <h2 class="h1-responsive about-section-headers-black">Engineering &amp; Science</h2>
                    <hr class = "my-4">
                    <!-- Section description -->
