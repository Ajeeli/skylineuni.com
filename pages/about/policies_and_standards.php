        ...
        <div class = "container my-5 py-3">
            <div class = "row">
                ...
                <div class = "col-3 pt-5 side-bar-menu">
                    <nav>
                        <ul>
                            ...
                            <a href = "policies_and_standards.php"><li class = "activeLink">Policies &amp; Standards</li></a>
                ...
                <div class = "col-md-8 mx-md-auto col-12 justify-content text-justify">
                    <h2 class="h1-responsive about-section-headers-black">Academic Integrity</h2>
                    <hr class = "my-4">      
                    <div class = "row my-5">
                        <div class = "col-12">
                            <!--<h3 class="h3-responsive about-section-headers-black">Academic Integrity</h3>-->
                            <!-- Section description -->
                            <p class = "main-text">
                            Our Skyline University mission and ideologies principles are that, each student acknowledges that the work represented in all assignments and all examinations is his/hers, or their own or is properly cited, and that he/she, or them has neither given nor received unauthorized information.
                            </p>
                            <p class = "main-text">
