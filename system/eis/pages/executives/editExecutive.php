<?php 
    ...
    if(isset($_GET['executiveID']) && $_GET['executiveID'] !== ''){
        $executiveID = $_GET['executiveID'];
        
        $sql = "SELECT * FROM executive WHERE executive_id = '$executiveID'";
            ...
            <div class = "col-6 breadcrumbDiv">
                <nav aria-label="breadcrumb" class = "path-nav">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Executives > Edit Executive</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class = "row frame-body">
            <div class = "col-10 offset-1">
                <form class = "adding-form py-5" action = "../../php/editing-form.php" method = "post" enctype="multipart/form-data">
                    ...
                    <div class = "form-row">
                        <div class = "col-12">
                            <input type = "hidden" class = "form-control" name = "executivesFormEdit" id = "executivesFormEdit" value = "executivesFormEdit">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class = "form-group col-12">
                            <label for="executiveID">Executive ID</label>
                            <input type = "text" class = "form-control" name = "executiveID" id = "executiveID" value = "<?php echo $executiveID; ?>" readonly>
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="inputCountry" name = "inputCountry" class="form-control" maxlength = "50" value = "<?php echo $country; ?>" required>
                                <option>...</option>
                            </select>
                        </div>
                    </div>
