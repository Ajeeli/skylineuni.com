            ...
            <div class = "col-6 breadcrumbDiv">
                <nav aria-label="breadcrumb" class = "path-nav">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Executives > Add Executive</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class = "row frame-body">
            <div class = "col-10 offset-1">
                <form class = "adding-form py-5" action = "../../php/adding-form.php" method = "post" enctype="multipart/form-data">
                    ...
                    <div class = "form-row">
                        <div class = "col-12">
                            <input type = "hidden" class = "form-control" name = "executivesForm" id = "executivesForm" value = "executivesForm">
                        </div>
                    </div>
                    <div class="form-row">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select id="inputCountry" name = "inputCountry" class="form-control" maxlength = "50" required>
                                <option>...</option>
                            </select>
                        </div>
                    </div>
