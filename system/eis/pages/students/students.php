...
<body class = "system-body">
    <div class = "container-fluid">
            ...
            <div class = "col-6 breadcrumbDiv">
                <nav aria-label="breadcrumb" class = "path-nav">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Students > All Students</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class = "row frame-body py-3">
            <div class = "col-6">
                <a role = "button" class="btn btn-primary" href = "addStudent.php">ADD NEW <i class="fas fa-plus fa-custom"></i></a>
            </div>
