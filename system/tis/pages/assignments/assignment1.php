                                                        ...
                                                        <div class="card text-center">
                                                            <div class="card-header">
                                                                <ul class="nav nav-tabs card-header-tabs">
                                                                    ...
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" href="assignment2.php">Assignment 2</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="card-body">
                                                                ...
                                                                if ($file1 == NULL){
                                                                    ...
                                                                    ?>
                                                                    <a href="files/<?php echo $file1; ?>" class="btn btn-success mt-2"><i class="fas fa-eye"></i> VIEW FILE</a>
                                                                    <a href="files/<?php echo $file1; ?>" class="btn btn-success mt-2" download><i class="fas fa-download"></i>  DOWNLOAD FILE</a>
